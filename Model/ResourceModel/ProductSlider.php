...
namespace Dotsquares\ProductSlider\Model\ResourceModel;
...
{
    const SLIDER_STORES_TABLE = 'dotsquares_productslider_stores';
    
    /**
     * Additional slider products table
     */
    const SLIDER_PRODUCTS_TABLE = 'dotsquares_productslider_products';
    ...
    {
        $this->_init('dotsquares_productslider', 'slider_id');
    }
    ...
    public function getSliderProducts($slider)
    {
        $select = $this->getConnection()->select()
            ->from(
                $this->getTable('dotsquares_productslider_products'),
                ['product_id', 'position']
            )->where(
                'slider_id = :slider_id'
            );
