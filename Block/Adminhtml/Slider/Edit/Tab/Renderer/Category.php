...
namespace Dotsquares\ProductSlider\Block\Adminhtml\Slider\Edit\Tab\Renderer;
...
/**
 * Class Category
 * @package Dotsquares\ProductSlider\Block\Adminhtml\Slider\Edit\Tab\Renderer
 */
class Category extends Multiselect
{
                            ...
                            "sliderCategory": {
                                ...
                                "children": {
                                    "slider_select_category": {
                                        "component": "Dotsquares_ProductSlider/js/components/new-category",
                                        "config": {
                                            "filterOptions": true,
                                            "disableLabel": true,
                                            "chipsEnabled": true,
    ...
    {
        $isNotAllowed = !$this->authorization->isAllowed('Dotsquares_ProductSlider::category');
