...
namespace Dotsquares\ProductSlider\Block;
...
use Dotsquares\ProductSlider\Model\ResourceModel\ProductSlider\Collection;
use Dotsquares\ProductSlider\Model\ResourceModel\ProductSlider\CollectionFactory;
...
class Slider extends Template implements BlockInterface
{
     ...
     */
    const XML_PATH_PRODUCT_SLIDER_STATUS = "dotsquares_productslider/general/enable_productslider";
   
    /**
     * Main template container
     */
    protected $_template = 'Dotsquares_ProductSlider::slider.phtml';
    ...
    public function setSlider($sliderCollection)
    {
        foreach ($sliderCollection as $slider):
            ...
            $this->append($this->getLayout()
                ->createBlock(\Dotsquares\ProductSlider\Block\Slider\Items::class)
                ->setSlider($slider));
        endforeach;
